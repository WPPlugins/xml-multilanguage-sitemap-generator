...
function giannini_generateSitemap(){
    ...
    if($sitemap_name){
        ...
        $sitemap_name = 'xml_mg_sitemap.xml';
    ...
    //Creazione della basi della sitemap.
    ...
    if ( is_plugin_active( 'sitepress-multilingual-cms/sitepress.php' ) ) {
        ...
        $query = new WP_Query( array( 'post_type' => $poststypetoinclude, 'post__not_in' => $idToExclude, 'posts_per_page' => -1) );
    ...
    elseif ( is_plugin_active( 'polylang/polylang.php' ) ){
        ...
        $query = new WP_Query( array( 'post_type' => $poststypetoinclude, 'post__not_in' => $idToExclude, 'lang' => $default_polylang_lang, 'posts_per_page' => -1 ) );
